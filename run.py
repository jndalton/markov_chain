...
catalog = {"Romeo and Juliet": "http://shakespeare.mit.edu/romeo_juliet/full.html",
...
def choose_number_passages():
    ...
    number_passages = int(raw_input("Enter a number 1-5: "))
...
def choose_number_words():
    ...
    number_words = int(raw_input("Enter a number 4-100: "))
    if number_words >= 4 and number_words <= 100:
        return number_words
    else:
